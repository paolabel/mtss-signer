...
if __name__ == '__main__':
    ...
    #     "                  -k (Valores maiores = menor assinatura,
    #                            valores menores = maior número de modificações possíveis, k >= 2)\n"
    #     "Para verificar assinatura:\n"
    #     "- Apenas com localização de erros:
    #       'verify <path do arquivo a verificar> <path da chave pública> <path da assinatura>'\n"
    #     "- Com localização e correção de erros:
    #       'verify-correct <path do arquivo a verificar> <path da chave pública> <path da assinatura>'\n"
    # )
